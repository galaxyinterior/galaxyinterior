...
export const metadata: Metadata = {
  ...
  description: 'Schedule an architectural consultation or visit our regional studios in Ranchi, Bhagalpur, Patna, and Kolkata. Verified helpline: +91 96319 80881.',
  openGraph: {
